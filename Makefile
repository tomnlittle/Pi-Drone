...
OBJS     = main.o PCA9685.o BNO055_driver-master_src/bno055.o drone_class.o motor_class.o SPI_Handler.o BNO055_Interface.o
CC=gcc
...
main.o: main.cpp PCA9685.h defines.h drone_class.h BNO055_Interface.h
